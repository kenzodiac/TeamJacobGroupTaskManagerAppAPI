...
builder.Services.AddCors(options => {
    ...
    builder => {
        builder.WithOrigins("http://localhost:3000", "http://localhost:3001", "http://localhost:3002", "http://localhost:3003", "http://localhost:3004", "https://taskmastergroup3.azurewebsites.net")
        .AllowAnyHeader()
        .AllowAnyMethod();
    });
});
